...
const ApproveDistrict = () => {
  ...
  if (role === 'ROLE_A') {
    apigetapprovalpending = `${apiPrefix}/admin/approval/distrtciapproval`
    apigetalreadyapproved = `${apiPrefix}/admin/approval/distrtciapprovedandrejected`
    apidownload = `${apiPrefix}/admin/approval/distrtciapproval/${userid}`
    approvereject = `${apiPrefix}/admin/approval/districtapproval`
    apiupdate = `${apiPrefix}/admin/approval/getupdateUserActivation`
  } else if (role === 'ROLE_S') {
    apigetapprovalpending = `${apiPrefix}/state/approval/getpendingdistrictuser/${userid}`
    apigetalreadyapproved = `${apiPrefix}/state/approval/distrtciapprovedandrejected/${userid}`
    apidownload = `${apiPrefix}/state/approval/distrtciapproval/${userid}`
    approvereject = `${apiPrefix}/state/approval/districtapproval`
    apiupdate = `${apiPrefix}/state/approval/getupdateUserActivation`
  }
  ...
  return (
    <div className="Container">
      ...
      <div className="card mt-2">
        ...
        <div className="card-body">
          <table id="approvealradydoctor" className="table  text-center table-bordered mt-4 pt-2">
            <thead>
              <tr>
                <th className='colorheadingotab' scope="col">
                  Sr No.
...
export default ApproveDistrict
