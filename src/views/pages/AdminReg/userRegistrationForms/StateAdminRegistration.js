...
import StateDropDownlist from './commonComponentForRegistration/StateDropDownlist'
...
const StateAdminRegistration = (props) => {
  ...
  const [ipaddress, setTransactionId] = useState(null)
  ...
  //     newErrors.selectedState = 'Select State is required';
  //     valid = false;
  //   }
  //   setErrors(newErrors);
  //   return valid;
  ...
  const validateOTPForm = () => {
    ...
    //   newErrors.emailotp = 'Mobile OTP is required';
    //   valid = false;
  ...
  //     scode: scode,
  //   }))
  //   console.log('Selected State:', scode)
  // }
      ...
      if (validateForm()) {
        try {
          ...
          const response = await fetch(
            `${process.env.REACT_APP_API_PREFIX}/alluser/stateregistration/getstateregistration`,
            {
              method: 'POST',
      ...
      <div className='row'>
        ...
        <div className='col-lg-10 col-10 col-10 col-sm-10 col-md-10'>
          ...
          <div className=" card mb-3 pb-3">
            <RegistrationTitle title="State Admin Registration Form" />
            <div className='card-body'>
              <div className="row p-3">

                <StateDropDownlist formData={formData} errors={errors} onChange={setFormData} />
                ...
                <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mt-2">
                  ...
                  {showStateDropdownSelection && (
                    <>
                      ...
                      {/* <CredentialsDetail onInputChange={handleInputChange} errors={errors} onChange={setFormData} /> */}
...
export default StateAdminRegistration
