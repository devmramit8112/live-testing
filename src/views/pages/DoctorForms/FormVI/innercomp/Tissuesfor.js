    ...
    <div className="container">
      <div className="card card-body">
        <div className="row mb-3">
          <div className="col-4">Type of Container</div>
          <div className="col-4">
            <input name="patient_name" type="text" className="form-control" />
          </div>
        </div>
        <div className="row mb-3">
          <div className="col-4">No of container(s)</div>
          <div className="col-4">
            <input name="patient_name" type="text" className="form-control" />
          </div>
        </div>
        <div className="row mb-3">
          <div className="col-4">No of seal(s)</div>
          <div className="col-4">
            <input name="patient_name" type="text" className="form-control" />
          </div>
        </div>
        <div className="row mb-3">
          <div className="col-4">Tissues for histopathological examination</div>
          <div className="col-4">
            <input name="patient_name" type="text" className="form-control" />
          </div>
        </div>
