...
const ImgModalPopupF2 = ({ closeModal, showModal, trn, imgid, isdesable, drw, imageSrc1, imageSrc10, handleremarksadd }) => {
    ...
    callApi(apigetkimg)
      .then((response) => {
        ...
        if (imgid === 1) {
          ...
          handleremarks.comments = handleremarksadd.remarks10
        }
...
export default ImgModalPopupF2
