...
const ImgModalPopup = ({closeModal,showModal,trn,imgid,isdesable,drw,imageSrc1,imageSrc2,imageSrc3,handleremarksadd}) => {
  ...
  const handlechange = (e) => {
    ...
    useEffect(() => {
          ...
          .then((response) => {
            ...
            if(imgid===2){
              handleremarks.comments= handleremarksadd.remarks1
            }else if (imgid===3){
              handleremarks.comments= handleremarksadd.remarks2
            }
            else{
