      ...
      <div className="card-body">
        <div className="row justify-content-center">
          <div className="row mb-3">
            ...
            <div className="col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">{userdata.vtName}</div>
          ...
          <div className="row mb-3">
            ...
            <div className="col-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">{userdata.vtGenderID}</div>
            <div className="col-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">Marital Status:</div>
            <div className="col-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">{userdata.vtmsID}</div>
          </div>
          <div className="row mb-3">
            <div className="col-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">Victim ID:</div>
            <div className="col-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">{userdata.vtUid}</div>
